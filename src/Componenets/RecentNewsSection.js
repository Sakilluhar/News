    ...
    <div id='rns-main'>
        ...
        <div id='rns-right-main' className=''>
            ...
            <div id='rns-PNews-main'>
                ...
                <div id='rns-PNews-card' class="card">
                    <img  id='rns-PNews-image' src={entertainment1_jpg} class="card-img-top" alt="..."/>
                    <div class="PNews-card-body">
                    <button id='btnrnsCatagory' className='btn btn-sm' type="button" >Technology</button>
                    <h4 id='rns-PNews-card-text' class="card-text">What we know about apple watch series 8</h4>
                    </div>
                </div>
